                        ...
                        <form @submit.prevent="login()">
                            <div class="rvt-card__content [ rvt-p-top-none rvt-m-top-none rvt-border-top-none ]">
                                ...
                                <ul class="rvt-list-plain">
                                    <label for="text-input-username" class="rvt-label">Username</label>
                                    <input type="text" id="text-input-username" class="rvt-text-input" v-model="username" placeholder="username" required>
...
import { API_CALL } from '../shared/contant';
